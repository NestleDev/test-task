...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_chat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/chat */ \"./source/js/modules/chat.js\");\n\nnew _modules_chat__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\n\n//# sourceURL=webpack:///./source/js/app.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return _default; });\n/* harmony import */ var _render__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./render */ \"./source/js/modules/render.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\nvar _default =\n/*#__PURE__*/\nfunction () {\n  function _default(selector, data) {\n    _classCallCheck(this, _default);\n\n    this.conteiner = document.querySelector(selector);\n    this.renderModal(data);\n  }\n\n  _createClass(_default, [{\n    key: \"renderModal\",\n    value: function renderModal(data) {\n      var _this = this;\n\n      if (data) {\n        this.conteiner.innerHTML = Object(_render__WEBPACK_IMPORTED_MODULE_0__[\"render\"])(\"modal-menu\", {\n          menu: data\n        });\n        setTimeout(function () {\n          _this.conteiner.classList.add(\"modal-active\");\n        }, 0);\n        this.conteiner.querySelector(\".modal-menu__close\").addEventListener(\"click\", function (event) {\n          _this.conteiner.classList.remove(\"modal-active\");\n        }, {\n          once: true\n        });\n      }\n    }\n  }]);\n\n  return _default;\n}();\n\n\n\n//# sourceURL=webpack:///./source/js/modules/modal.js?");

/***/ }),

/***/ "./source/js/modules/render.js":
/*!*************************************!*\
  !*** ./source/js/modules/render.js ***!
  \*************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"render\", function() { return render; });\nvar render = function render(template, data) {\n  return __webpack_require__(\"./source/view/templates sync recursive ^\\\\.\\\\/.*\\\\.hbs$\")(\"./\".concat(template, \".hbs\"))(data);\n};\n\n//# sourceURL=webpack:///./source/js/modules/render.js?");

/***/ }),

/***/ "./source/view/templates sync recursive ^\\.\\/.*\\.hbs$":
/*!**************************************************!*\
  !*** ./source/view/templates sync ^\.\/.*\.hbs$ ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("var map = {\n\t\"./messages.hbs\": \"./source/view/templates/messages.hbs\",\n\t\"./modal-menu.hbs\": \"./source/view/templates/modal-menu.hbs\",\n\t\"./users.hbs\": \"./source/view/templates/users.hbs\"\n};\n\n\nfunction webpackContext(req) {\n\tvar id = webpackContextResolve(req);\n\treturn __webpack_require__(id);\n}\nfunction webpackContextResolve(req) {\n\tvar id = map[req];\n\tif(!(id + 1)) { // check for number or string\n\t\tvar e = new Error(\"Cannot find module '\" + req + \"'\");\n\t\te.code = 'MODULE_NOT_FOUND';\n\t\tthrow e;\n\t}\n\treturn id;\n}\nwebpackContext.keys = function webpackContextKeys() {\n\treturn Object.keys(map);\n};\nwebpackContext.resolve = webpackContextResolve;\nmodule.exports = webpackContext;\nwebpackContext.id = \"./source/view/templates sync recursive ^\\\\.\\\\/.*\\\\.hbs$\";\n\n//# sourceURL=webpack:///./source/view/templates_sync_^\\.\\/.*\\.hbs$?");

/***/ }),

/***/ "./source/view/templates/messages.hbs":
/*!********************************************!*\
  !*** ./source/view/templates/messages.hbs ***!
  \********************************************/
/*! no static exports found */
